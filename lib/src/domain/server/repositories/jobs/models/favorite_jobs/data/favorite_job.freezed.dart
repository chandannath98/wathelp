...
FavoriteJob _$FavoriteJobFromJson(Map<String, dynamic> json) {
  return _FavoriteJob.fromJson(json);
}
...
mixin _$FavoriteJob {
  ...
  @JsonKey(ignore: true)
  $FavoriteJobCopyWith<FavoriteJob> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $FavoriteJobCopyWith<$Res> {
  factory $FavoriteJobCopyWith(
          FavoriteJob value, $Res Function(FavoriteJob) then) =
      _$FavoriteJobCopyWithImpl<$Res, FavoriteJob>;
  @useResult
  $Res call(
...
/// @nodoc
class _$FavoriteJobCopyWithImpl<$Res, $Val extends FavoriteJob>
    implements $FavoriteJobCopyWith<$Res> {
  _$FavoriteJobCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$FavoriteJobImplCopyWith<$Res>
    implements $FavoriteJobCopyWith<$Res> {
  factory _$$FavoriteJobImplCopyWith(
          _$FavoriteJobImpl value, $Res Function(_$FavoriteJobImpl) then) =
      __$$FavoriteJobImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: 'title') String? title,
...
/// @nodoc
class __$$FavoriteJobImplCopyWithImpl<$Res>
    extends _$FavoriteJobCopyWithImpl<$Res, _$FavoriteJobImpl>
    implements _$$FavoriteJobImplCopyWith<$Res> {
  __$$FavoriteJobImplCopyWithImpl(
      _$FavoriteJobImpl _value, $Res Function(_$FavoriteJobImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$FavoriteJobImpl(
      title: freezed == title
          ? _value.title
          : title // ignore: cast_nullable_to_non_nullable
              as String?,
...
/// @nodoc
@JsonSerializable()
class _$FavoriteJobImpl with DiagnosticableTreeMixin implements _FavoriteJob {
  const _$FavoriteJobImpl(
  ...
  factory _$FavoriteJobImpl.fromJson(Map<String, dynamic> json) =>
      _$$FavoriteJobImplFromJson(json);
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty('type', 'FavoriteJob'))
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$FavoriteJobImplCopyWith<_$FavoriteJobImpl> get copyWith =>
      __$$FavoriteJobImplCopyWithImpl<_$FavoriteJobImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$FavoriteJobImplToJson(
      this,
    );
  }
}

abstract class _FavoriteJob implements FavoriteJob {
  const factory _FavoriteJob(
      ...
      @JsonKey(name: 'allAppliedJobs_count')
      final int? allAppliedJobsCount}) = _$FavoriteJobImpl;

  factory _FavoriteJob.fromJson(Map<String, dynamic> json) =
      _$FavoriteJobImpl.fromJson;
