...
class _$LanguageImpl with DiagnosticableTreeMixin implements _Language {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Language(id: $id, name: $name, code: $code, icon: $icon, direction: $direction, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, id, name, code, icon, direction, createdAt, updatedAt);
